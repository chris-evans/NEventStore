namespace NEventStore.Serialization.AcceptanceTests
{
    ...
    public class when_serializing_an_untyped_payload_on_a_snapshot : SerializationConcern
    {
        ...
        {
            _deserialized.Payload.Should().BeInstanceOf(_snapshot.Payload.GetType());
        }
    }

    public class SerializationConcern : SpecificationBase<TestFixture>, IUseFixture<SerializerFixture>
    {
